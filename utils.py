...
class SquidBed(discord.Embed):
    ...
    def __init__(self, **kwargs):
        ...
        self.SquidBed_args = kwargs

        self.set_color_name()
        self.set_author_by_user()

        del self.SquidBed_args
